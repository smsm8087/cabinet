                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_ASTAR, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ASTAR));
	CMainApp Game;
	// 기본 메시지 루프입니다.
...
{
   HWND hWnd;
   RECT rc = {0, 0, TILE_SIZE * TILE_SQUARE, TILE_SIZE * TILE_SQUARE};
