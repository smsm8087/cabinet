...
{
	return (cBullet *)(new cBullet)->AutoRelease();
}
...
void cBullet::OnReceiveMessage(cObject * pSender, string sMessageType, void * pMessage)
{
	if (sMessageType == "PlayerDie")
	{
		//char* szMsg = reinterpret_cast<char*>(pMessage);
		char* szMsg = (char*)pMessage;
		m_isActive = false;
	}
}
